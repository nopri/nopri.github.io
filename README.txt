...
Python Programming Language Training Material (seventh edition, 2009):
id-python.pdf
id-python.odt

SQLiteBoy Book (second edition, 2014):
...
noprianto-professional_enduser_se.pdf

Example of Object Oriented Programming In Python Programming Language
(Bina Nusantara University, 2016-May-10)
noprianto-example_oop_python.pdf

Example of Simple Unit Testing In Python Programming Language (unittest module)
